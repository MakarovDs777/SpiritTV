...
Вот вторая версия https://codepen.io/HoytII/pen/xbbjMaq где можно изменять количество фреймов. Для тех у кого слишком долго загружается, и так же можно вводить любое число а не только от 1 до 19. И потом отпиши смог ли ты пообщаться с призраками...
